...
## Some Tips:
    ...
    3. If you choose to see single flows in 'dots', you can see a lot of circles in different size; however, the dots are not clickable and can't be selected through the right-side table.
